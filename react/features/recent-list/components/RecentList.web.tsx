...
import { buildDesktopRoomLink } from '../../deep-linking/openDesktopApp.web';
    ...
    override render() {
        ...
        const meetings = desktopCfg?.enabled && desktopCfg.appScheme
            ? recentList.map(meeting => {
                const deepLink = buildDesktopRoomLink(meeting.url, desktopCfg.appScheme);
                ...
                return {
                    ...
                    elementAfter: (
                        <button
                            ...
                            tabIndex = { 0 }
                            title = { t('welcomepage.openInDesktopApp') }
                            type = 'button'>
